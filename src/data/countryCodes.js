// ISO 3166-1 alpha-2 code + international dial code.
// The flag emoji is derived from the ISO code via regional indicator symbols.
...
export const countryByIso = (iso) => COUNTRIES.find((c) => c.iso === iso)
